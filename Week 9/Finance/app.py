...
def add_cash():
    ...
    if not new_cash:
        return apology("You Must Add Cash!")
...
def register():
    ...
    if request.method == "GET":
        ...
        if not username:
            return apology("You Must Give a Userame!")

        if not password:
            return apology("You Must give a Password!")

        if not confirmation:
            return apology("You Must give a Confirmation!")
        ...
        try:
            ...
            return apology("Password already exists!")
...
def sell():
    ...
    if request.method == "GET":
        ...
        if shares > user_shares_real:
            return apology("THIS IS NOT Available, YOU Don't Have The Amount OF Shares!")
